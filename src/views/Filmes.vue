<template>
  <div>
    ...
    <v-card class="mx-auto" elevation="0">
      ...
      <v-expand-transition>
        <v-sheet v-if="modelNowPlaying != null" class="px-10 pb-5">
              ...
              <v-col cols="12" sm="12" md="3" lg="3" xl="2">
                ...
                >
                  <v-list-item
                    ...
                    @click="
                      eventWatchProviders(
                        moviesNowPlaying[modelNowPlaying].id,
                        moviesNowPlaying[modelNowPlaying].title
                      )
                    "
                  >
                  ...
                  <v-card-title class="text-h4">
                    <v-row no-gutters justify="space-between" align="center">
                      ...
                      <v-col cols="2" sm="1" md="1" lg="1">
                        ...
                        >
                          {{ moviesNowPlaying[modelNowPlaying].vote_average }}
                        </v-avatar>
                        ...
                        <v-card-title class="text-white">
                          <v-row no-gutters>
                            ...
                            <v-btn
                              ...
                              @click="
                                eventWatchColection(
                                  moviesDetails.belongs_to_collection.id
                                )
                              "
                    ...
                    <v-row justify="space-between" align="center">
                      <v-col cols="12" sm="7" md="6" lg="5" xl="4">
                        ...
                        <v-btn
                          ...
                          @click="
                            eventMoreDetails(
                              moviesNowPlaying[this.modelNowPlaying].id
                            )
                          "
                          >Saiba mais</v-btn
                        >
    ...
    <v-card class="mx-auto" elevation="0">
      ...
      <v-expand-transition>
        <v-sheet v-if="modelPopular != null" class="px-10 pb-5">
          <v-card variant="outlined" rounded="xl">
            <v-row no-gutters>
              <v-col cols="12" sm="12" md="3" lg="3" xl="2">
                <v-img
                ...
                >
                  <v-list-item
                    ...
                    @click="
                      eventWatchProviders(
                        this.moviesPopular[this.modelPopular].id,
                        this.moviesPopular[this.modelPopular].title
                      )
                    "
                  >
                    <template v-slot:prepend>
                    ...
                    <v-row no-gutters justify="space-between" align="center">
                      ...
                      <v-col cols="2" sm="1" md="1" lg="1">
                        <v-avatar
                          ...
                          class="d-none d-md-flex text-body-1"
                        >
                          {{ moviesPopular[modelPopular].vote_average }}
                        </v-avatar>
    ...
    <v-card class="mx-auto" elevation="0">
      ...
      <v-expand-transition>
        <v-sheet v-if="modelTopRated != null" class="px-10 pb-5">
          <v-card variant="outlined" rounded="xl">
            <v-row no-gutters>
              <v-col cols="12" sm="12" md="3" lg="3" xl="2">
                <v-img
                ...
                >
                  <v-list-item
                    ...
                    @click="
                      eventWatchProviders(
                        moviesTopRated[modelTopRated].id,
                        moviesTopRated[modelTopRated].title
                      )
                    "
                  >
                    <template v-slot:prepend>
                    ...
                    <v-row no-gutters justify="space-between" align="center">
                      ...
                      <v-col cols="2" sm="1" md="1" lg="1">
                        <v-avatar
                          ...
                          class="d-none d-md-flex text-body-1"
                        >
                          {{ moviesTopRated[modelTopRated].vote_average }}
                        </v-avatar>
                    ...
                    <v-row justify="space-between" align="center">
                      <v-col cols="12" sm="7" md="6" lg="5" xl="4">
                        ...
                        <v-btn
                          ...
                          @click="
                            eventMoreDetails(
                              moviesTopRated[this.modelTopRated].id
                            )
                          "
                          >Saiba mais</v-btn
                        >
  ...
  <MoviesProviders ref="MoviesProviders" :id="movieId" :title="movieTitle" :tvOrMovie="'movie'" />
